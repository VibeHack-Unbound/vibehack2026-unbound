...
function CatFloating({ size }: { size: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="relaxed floating cat">
      ...
      <path d="M84 80 Q90 74 96 80" stroke="#FAF6F0" strokeWidth="3" strokeLinecap="round" fill="none" />
      <path d="M104 80 Q110 74 116 80" stroke="#FAF6F0" strokeWidth="3" strokeLinecap="round" fill="none" />
      <ellipse cx="100" cy="88" rx="3" ry="2" fill="#F5C5D1" />
      <path d="M92 93 Q100 100 108 93" stroke="#F5C5D1" strokeWidth="2.5" strokeLinecap="round" fill="none" />
      ...
      <path d="M130 140 Q155 130 158 115 Q162 100 150 98" stroke="#2C3E35" strokeWidth="10" strokeLinecap="round" fill="none" />
...
function CatOnCloud({ size }: { size: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="calm cat on cloud">
      ...
      <path d="M93 95 Q100 100 107 95" stroke="#F5C5D1" strokeWidth="2.5" strokeLinecap="round" fill="none" />
      <path d="M128 138 Q148 130 150 118 Q152 106 142 104" stroke="#2C3E35" strokeWidth="10" strokeLinecap="round" fill="none" />
...
function CatHanging({ size }: { size: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="droopy hanging cat">
      <path d="M100 20 Q100 10 108 10 Q116 10 116 18" stroke="#A89F94" strokeWidth="3" strokeLinecap="round" fill="none" />
      <path d="M100 20 L60 48 L140 48 Z" stroke="#A89F94" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" fill="none" />
      ...
      <path d="M93 97 Q100 93 107 97" stroke="#F5C5D1" strokeWidth="2.5" strokeLinecap="round" fill="none" />
      <ellipse cx="100" cy="91" rx="3" ry="2" fill="#F5C5D1" />
      <path d="M128 148 Q140 155 138 168 Q136 178 128 176" stroke="#2C3E35" strokeWidth="10" strokeLinecap="round" fill="none" />
...
function CatCurled({ size }: { size: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="curled up cat">
      <path d="M55 140 Q50 100 80 88 Q110 76 130 88 Q155 102 150 140 Q130 165 100 165 Q70 165 55 140Z" fill="#2C3E35" />
      <path d="M55 140 Q42 160 60 172 Q80 182 100 178 Q120 174 130 165" stroke="#2C3E35" strokeWidth="12" strokeLinecap="round" fill="none" />
      ...
      <path d="M84 94 Q90 90 96 94" stroke="#2C3E35" strokeWidth="2" strokeLinecap="round" fill="none" />
      <path d="M104 94 Q110 90 116 94" stroke="#2C3E35" strokeWidth="2" strokeLinecap="round" fill="none" />
      <path d="M94 110 Q100 106 106 110" stroke="#F5C5D1" strokeWidth="2" strokeLinecap="round" fill="none" />
...
function CatWrapped({ size }: { size: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="wrapped anxious cat">
      <path d="M48 130 Q44 90 100 82 Q156 90 152 130 Q148 175 100 178 Q52 175 48 130Z" fill="#C4B5A5" />
      <path d="M60 100 Q100 92 140 100" stroke="#B0A090" strokeWidth="2" strokeLinecap="round" fill="none" />
      <path d="M55 115 Q100 106 145 115" stroke="#B0A090" strokeWidth="1.5" strokeLinecap="round" fill="none" />
      ...
      <path d="M78 62 Q86 57 94 62" stroke="#FAF6F0" strokeWidth="2.5" strokeLinecap="round" fill="none" />
      <path d="M106 62 Q114 57 122 62" stroke="#FAF6F0" strokeWidth="2.5" strokeLinecap="round" fill="none" />
      <path d="M94 88 Q100 85 106 88" stroke="#F5C5D1" strokeWidth="2" strokeLinecap="round" fill="none" />
...
export function CatIllustration({ tier = 1, size = 160, className = '' }: CatIllustrationProps) {
  ...
  switch (tier) {
    case 1: return <div className={catClass}><CatFloating size={size} /></div>
    case 2: return <div className={catClass}><CatOnCloud size={size} /></div>
    case 3: return <div className={catClass}><CatHanging size={size} /></div>
    case 4: return <div className={catClass}><CatCurled size={size} /></div>
    case 5: return <div className={catClass}><CatWrapped size={size} /></div>
    default: return <div className={catClass}><CatFloating size={size} /></div>
  }
}
